...
//
// Allow Players to work backpacks of other players. This is not vItems, I inventory only
//
...
//
// Looting dead players. As if there would be something they can do about it. Because. They are dead.
//
// :P
//
