...
class Life_Settings {
    ...
    /* Impound Variables */
    impound_car = 35; //Price for impounding cars
    impound_boat = 25; //Price for impounding boats
    impound_air = 85; //Price for impounding helicopters / planes
    ...
    /* Job-related stuff */
    delivery_points[] = {
		"dp_1", "dp_2", "dp_3", "dp_4", "dp_5", "dp_6", "dp_7", "dp_8", "dp_9",
		"dp_10", "dp_11", "dp_12", "dp_13", "dp_14", "dp_15", "dp_15", "dp_16",
		"dp_17", "dp_18", "dp_19", "dp_20", "dp_21", "dp_22", "dp_23", "dp_24",
		"dp_25"
	};
